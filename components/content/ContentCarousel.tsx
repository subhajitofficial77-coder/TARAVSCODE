      ...
      <div className="overflow-hidden">
        ...
        >
          {panels.map((panel, idx: number) => {
            ...
            const emotionKey = (dominant as any) || 'joy';

            // bind tilt/scale/translate to the shared x value for dynamic 3D effect
            const rel = useTransform(trackX, (v) => v + idx * trackItemOffset);
            ...
            return (
              <motion.div
                key={panel.id}
                style={{ width: itemWidth, transformStyle: 'preserve-3d' } as any}
                className="mr-4"
              >
                <motion.div
